...
module.exports = {
  ...
  networks: {
    ...
    ropsten: {
      provider: function() {
        return new HDWalletProvider(mnemonic_ropsten, "https://ropsten.infura.io/v3/INFURA-PROJECT-ID")
      },
      network_id: 3
    },
    kovan: {
      provider: function() {
        return new HDWalletProvider(mnemonic_kovan, "https://kovan.infura.io/v3/INFURA-PROJECT-ID")
      },
      network_id: 42
    },
    live: {
      ...
      network_id: 1,
      gasPrice: 21500000000,  // 157 gwei (in wei) (default: 100 gwei)
