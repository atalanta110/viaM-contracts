...
*/
interface RariERC1155TokenReceiver {
    /**
 ...
 */
abstract contract RariIERC1155 is RariIERC165 {
    /**
 ...
 */
contract RariERC165 is RariIERC165 {
    /*
...
contract RariERC1155 is RariIERC1155, RariERC165, RariCommonConstants
{
    using RariSafeMath for uint256;
    using RariAddress for address;
...
/////////////////////////////////////////// Internal //////////////////////////////////////////////
    ...
    function _doSafeTransferAcceptanceCheck(address _operator, address _from, address _to, uint256 _id, uint256 _value, bytes memory _data) internal {
        ...
        require(RariERC1155TokenReceiver(_to).onERC1155Received(_operator, _from, _id, _value, _data) == ERC1155_ACCEPTED, "contract returned an unknown value from onERC1155Received");
    }
    ...
    function _doSafeBatchTransferAcceptanceCheck(address _operator, address _from, address _to, uint256[] memory _ids, uint256[] memory _values, bytes memory _data) internal {
        ...
        require(RariERC1155TokenReceiver(_to).onERC1155BatchReceived(_operator, _from, _ids, _values, _data) == ERC1155_BATCH_ACCEPTED, "contract returned an unknown value from onERC1155BatchReceived");
    }
}

library RariUintLibrary {
...
library RariStringLibrary {
    using RariUintLibrary for uint256;
...
contract RariHasContractURI is RariERC165 {
...
contract RariHasTokenURI {
    using RariStringLibrary for string;
 ...
 * the owner.
 */
contract RariOwnable is RariContext {
...
*/
interface RariIERC1155Metadata_URI {
    /**
...
/**
    Note: The ERC-165 identifier for this interface is 0x0e89341c.
*/
contract RariERC1155Metadata_URI is RariIERC1155Metadata_URI, RariHasTokenURI {

    constructor(string memory _tokenURIPrefix) RariHasTokenURI(_tokenURIPrefix) public {
...
abstract contract RariHasSecondarySaleFees is RariERC165 {
...
contract RariERC1155Base is RariHasSecondarySaleFees, RariOwnable, RariERC1155Metadata_URI, RariHasContractURI, RariERC1155 {
    ...
    constructor(string memory contractURI, string memory tokenURIPrefix) RariHasContractURI(contractURI) RariERC1155Metadata_URI(tokenURIPrefix) public {
...
contract RariSignerRole is RariContext {
    using RariRoles for RariRoles.Role;

    event SignerAdded(address indexed account);
    event SignerRemoved(address indexed account);

    RariRoles.Role private _signers;
...
contract RaribleToken is RariOwnable, RariSignerRole, RariERC1155Base {
    string public name;
    string public symbol;

    constructor(string memory _name, string memory _symbol, address signer, string memory contractURI, string memory tokenURIPrefix) RariERC1155Base(contractURI, tokenURIPrefix) public {
        name = _name;
        symbol = _symbol;
    ...
    function mintDebug(uint256 id, Fee[] memory fees, uint256 supply, string memory uri) public {
        _mint(id, fees, supply, uri);
    }
}