...
/*
	...
	V2 updates:
	- uses YieldClaimable interface (setYieldDistributor, claimYield) to
	  collect yield in vairous tokens (not matching pool base asset) or raw ETH;
	- method to convert and redistribute such yield too;
*/
contract HolyRedeemerV2 is AccessControlUpgradeable {
