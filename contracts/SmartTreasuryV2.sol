...
contract SmartTreasuryV2 is ERC20PresetMinterPauserUpgradeableDecimals, ERC20PermitUpgradeableDecimals, SafeAllowanceResetUpgradeable {
    ...
    // TODO: check that calculations are not bound to balanceOf(SLP), but on totalStakedMoveEthLP
    // because most SLPs would be staked in MasterChef for SUSHI rewards
